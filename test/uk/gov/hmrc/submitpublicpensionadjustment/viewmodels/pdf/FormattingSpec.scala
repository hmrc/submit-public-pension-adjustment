  ...
  "Formatting" - {
    ...
    "format(whatNewProtectionTypeEnhancement: Option[WhatNewProtectionTypeEnhancement])" - {
      "should format WhatNewProtectionTypeEnhancement correctly" in {
        ...
        formatter.format(Some(WhatNewProtectionTypeEnhancement.IndividualProtection2014)) shouldBe "Individual protection 2014"
        formatter.format(Some(WhatNewProtectionTypeEnhancement.IndividualProtection2016)) shouldBe "Individual protection 2016"
    ...
    "formatProtectionType(protectionType: Option[ProtectionType])" - {
      "should format ProtectionType correctly" in {
        ...
        formatter.formatProtectionType(Some(ProtectionType.IndividualProtection2014)) shouldBe "Individual protection 2014"
        formatter.formatProtectionType(Some(ProtectionType.IndividualProtection2016)) shouldBe "Individual protection 2016"
    ...
    "formatEnhancementType(enhancementType: Option[EnhancementType])" - {
      "should format EnhancementType correctly" in {
        formatter.formatEnhancementType(Some(EnhancementType.InternationalEnhancement)) shouldBe "International Enhancement"
    ...
    "formatNewEnhancementType(newEnhancementType: Option[NewEnhancementType])" - {
      "should format NewEnhancementType correctly" in {
        formatter.formatNewEnhancementType(Some(NewEnhancementType.InternationalEnhancement)) shouldBe "International Enhancement"
    ...
    "formatNewExcessLifetimeAllowancePaid(newExcessLifetimeAllowancePaid: Option[NewExcessLifetimeAllowancePaid])" - {
      "should format NewExcessLifetimeAllowancePaid correctly" in {
        formatter.formatNewExcessLifetimeAllowancePaid(Some(NewExcessLifetimeAllowancePaid.Annualpayment)) shouldBe "Annual Payment"
