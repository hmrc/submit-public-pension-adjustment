...
object TestSection extends Formatting {
  def build(finalSubmission: FinalSubmission): TestSection =
    TestSection(
      thresholdIncomeAmount = finalSubmission.incomeSubJourney.thresholdIncomeAmount.toString
    )
}
