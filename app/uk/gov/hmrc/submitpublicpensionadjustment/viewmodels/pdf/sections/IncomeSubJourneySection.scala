...
case class IncomeSubJourneySubSection(period: String, reducedNetIncome: String, thresholdIncomeAmount: String, adjustedIncomeAmount: String, personalAllowanceAmount: String) {}
